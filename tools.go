...
const randomStringSource = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOQPRSTUVWXYZ0123456789_+"
...
// UploadedFils is a struct used to save information about an updated file
...
func (t *Tools) UploadedFiles(r *http.Request, uploadDir string, rename ...bool) ([]*UploadedFile, error) {
	...
	err := r.Response.Request.ParseMultipartForm(int64(t.MaxFileSize))
	if err != nil {
	...
	for _, fHeaders := range r.MultipartForm.File {
		for _, hdr := range fHeaders {
			uploadedFiles, err = func(uploadedFiles []*UploadedFile) ([]*UploadedFile, error) {
				...
				fmt.Println("MJK uploadedFile.NewFileName:", uploadedFile.NewFileName)
				var outfile *os.File
				defer outfile.Close()
